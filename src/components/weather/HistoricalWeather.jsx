...
export default function HistoricalWeather() {
  ...
  const { data: historicalData, isLoading, error } = useGetHistoricalWeatherQuery({
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center min-h-[50vh]">
        <div className="animate-pulse text-xl text-gray-500">Loading historical data...</div>
      </div>
    );
  }
    ...
    return (
      <div className="flex justify-center items-center min-h-[50vh]">
        <div className="text-red-500 text-center">
          <p className="text-2xl font-bold mb-2">Error loading historical data</p>
          <p>{error?.data?.error?.message || 'Unable to fetch historical weather information'}</p>
        </div>
      </div>
    );
  }
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <p className="text-xl font-semibold">
                  {unit === 'c'
                    ...
                    : historicalData.forecast.forecastday[0].day.maxwind_mph} {unit === 'c' ? 'km/h' : 'mph'}
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <p className="text-xl font-semibold">
                  {unit === 'c'
                    ...
                    : historicalData.forecast.forecastday[0].day.totalprecip_in} {unit === 'c' ? 'mm' : 'in'}
                </p>
              </div>
          ...
          <div className="mt-8">
            ...
            <div className="overflow-x-auto pb-2">
              <div className="inline-flex gap-4">
                {historicalData.forecast.forecastday[0].hour.filter((_, i) => i % 3 === 0).map((hour) => (
                  <motion.div
                    key={hour.time}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2 text-xs text-center">
                      <div>
                        ...
                        <p>{unit === 'c' ? hour.precip_mm : hour.precip_in} {unit === 'c' ? 'mm' : 'in'}</p>
                      </div>
                      <div>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="text-center">
                  ...
                  <p className="text-lg font-medium">{formatTemperature(24, unit)}</p>
                </div>
